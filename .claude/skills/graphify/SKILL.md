...
Before the merge step, save the old graph: `Copy-Item .graphify\graph.json .graphify/.graphify_old.json`
Clean up after: `Remove-Item -ErrorAction SilentlyContinue .graphify/.graphify_old.json`
