...
## Corpus Check
- 168 files · ~86.635 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 683 nodes · 1512 edges · 37 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: contains: 515 · imports: 366 · imports_from: 332 · re_exports: 177 · calls: 96 · method: 26
...
- Excluded: 0 untracked · 66460 ignored · 3 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `d63e381`
...
Cohesion: 0.06
Nodes (52): ImageViewerModal(), CharacterCard, TAB_ICON, TabBarProps, haptics, Icon(), IconName, ICONS (+44 more)
...
Cohesion: 0.24
Nodes (9): CONTEXT_PRESETS, QuickSettingsSheet(), safe(), syncOai(), syncPersonaToPc(), syncPowerUser(), syncRoot(), syncSelectedProfileToPc() (+1 more)
...
- **Thin community `Community 32`** (2 nodes): `entryUid()`, `LoreSheet()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (2 nodes): `{ defineConfig }`, `expoConfig`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (2 nodes): `PROPS`, `{ withGradleProperties }`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (1 nodes): `config`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (1 nodes): `{ withAppBuildGradle }`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `StClient` connect `Community 13` to `Community 3`, `Community 7`?**
